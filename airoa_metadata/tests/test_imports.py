...
class TestMainPackageImports:
    ...
    def test_package_metadata(self):
        ...
        from airoa_metadata import __version__, __author__
...
class TestVersionImports:
    ...
    def test_version_imports(self):
        ...
        from airoa_metadata.versions import (
            MetadataV0_0, MetadataV1_0, MetadataV1_1, MetadataV1_2, MetadataV1_3,
            VERSIONS, LATEST_VERSION, MetadataLatest
        )
...
class TestSchemaImports:
    ...
    def test_schema_imports(self):
        ...
        from airoa_metadata.schemas import (
            get_schema_path, load_schema, AVAILABLE_SCHEMAS
        )
