...
from airoa_metadata.schemas import get_schema_path, load_schema, AVAILABLE_SCHEMAS
    ...
    def test_schema_definitions(self):
        ...
        for version in ["1.2", "1.3"]:  # Newer versions have definitions
            ...
            if "definitions" in schema:
                ...
                expected_definitions = ["file", "entity", "component", "instruction", "segment"]
                for definition in expected_definitions:
                    assert definition in definitions, f"Missing {definition} in {version} schema"
